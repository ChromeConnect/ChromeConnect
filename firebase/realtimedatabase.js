    ...
    !function () {
          ...
          encodeByteArray: function (e, t) {
            ...
            for (
              ...
              var o = e[i],
                ...
                l = 63 & l;
              u || ((l = 64), a || (h = 64)),
                r.push(n[o >> 2], n[((3 & o) << 4) | (s >> 4)], n[h], n[l]);
            }
            return r.join("");
          },
      ...
      function I(e, t, n) {
        ...
        return (
          ...
          Error.captureStackTrace &&
            Error.captureStackTrace(t, S.prototype.create),
          t
        );
      }
      var S =
      ...
      var Y = "[DEFAULT]",
        K =
          ...
          (G.prototype.clearInstance = function (e) {
            this.instancesDeferred.delete((e = void 0 === e ? Y : e)),
          ...
          (G.prototype.normalizeInstanceIdentifier = function (e) {
            return (
              void 0 === e && (e = Y),
              !this.component || this.component.multipleInstances ? e : Y
            );
          }),
      ...
      function pe(e, t) {
        g(
          ...
          !0 === e
            ? ((be.logLevel = $.VERBOSE),
              (Ie = be.log.bind(be)),
              t && Ce.set("logging_enabled", !0))
            : "function" == typeof e
            ? (Ie = e)
            : ((Ie = null), Ce.remove("logging_enabled"));
      }
      function de() {
      ...
      var ge,
        ...
        ke = function () {
          ...
          !0 === Se &&
            ((Se = !1),
            null === Ie && !0 === Ce.get("logging_enabled") && pe(!0)),
            Ie && ((e = Ee.apply(null, t)), Ie(e));
        },
        Pe = function (n) {
          return function () {
            for (var e = [], t = 0; t < arguments.length; t++)
      ...
      var qe = new RegExp("^-?(0*)\\d{1,10}$"),
        ...
        Ve =
          ((ze.prototype.getToken = function (n) {
            var r = this;
      ...
      var Ge =
        ...
        Je = "long_polling",
        Xe =
          ((Ze.prototype.isCacheableHost = function () {
            ...
            set: function (e) {
              e !== this.internalHost &&
                ...
                this.isCacheableHost() &&
                  we.set("host:" + this._host, this.internalHost));
            },
            enumerable: !1,
            configurable: !0,
          }),
      ...
      function Ze(e, t, n, r, i, o, a) {
        void 0 === i && (i = !1),
          ...
          (this.internalHost = we.get("host:" + e) || this._host);
      }
      function et(e, t, n) {
        var r;
        if (
      ...
      var tt =
        ((nt.prototype.incrementCounter = function (e, t) {
          void 0 === t && (t = 1),
      ...
      var at =
        ((st.prototype.closeAfter = function (e, t) {
      ...
      var ut = "pLPCommand",
        lt = "pRTLPCB",
        ht =
          ((ct.prototype.open = function (e, t) {
            var n,
              r,
              i,
              a = this;
            (this.curSegmentNum = 0),
              ...
              (n = function () {
                ...
                a.isClosed_ ||
                  ...
                  a.appCheckToken && (e.ac = a.appCheckToken),
                  "undefined" != typeof location &&
                    location.hostname &&
                    Ge.test(location.hostname) &&
                    (e.r = "f"),
                  (e = a.urlFn(e)),
          ...
          (ct.prototype.markConnectionHealthy = function () {}),
          (ct.prototype.shutdown_ = function () {
            (this.isClosed_ = !0),
          ...
          setTimeout(function () {
            try {
              ...
              (t.type = "text/javascript"),
                ...
                (t.onerror = function () {
                  ke("Long-poll script failed to load: " + e),
                    (r.sendNewPolls = !1),
                    r.close();
                }),
      ...
      function dt(e, t, n, r) {
        (this.onDisconnect = n),
          ...
          (this.sendNewPolls = !0),
          (this.uniqueCallbackIdentifier = Te()),
          (window[ut + this.uniqueCallbackIdentifier] = e),
          (window[lt + this.uniqueCallbackIdentifier] = t),
          (this.myIFrame = dt.createIFrame_());
        (t = ""),
          (t =
            "<html><body>" +
            (t =
      ...
      var _t =
        ((yt.connectionURL_ = function (e, t, n, r) {
          var i = { v: "5" };
          return (
            "undefined" != typeof location &&
              location.hostname &&
        ...
        (yt.isAvailable = function () {
          ...
          return (
            "undefined" != typeof navigator &&
              ...
              parseFloat(e[1]) < 4.4 &&
              (t = !0),
            !t && null !== ft && !yt.forceDisallow_
          );
        }),
        (yt.previouslyFailed = function () {
          return (
            we.isInMemoryStorage || !0 === we.get("previous_websocket_failure")
          );
        }),
        ...
        (yt.responsesRequiredToBeHealthy = 2),
        (yt.healthyTimeout = 3e4),
        yt);
      function yt(e, t, n, r, i, o, a) {
        (this.connId = e),
          ...
          (this.bytesSent = 0),
          (this.bytesReceived = 0),
          (this.log_ = Pe(this.connId)),
          (this.stats_ = ot(t)),
          (this.connURL = yt.connectionURL_(t, o, a, r)),
          (this.nodeAdmin = t.nodeAdmin);
      }
      var vt =
        (Object.defineProperty(gt, "ALL_TRANSPORTS", {
          get: function () {
            return [ht, _t];
          },
          enumerable: !1,
        ...
        (gt.prototype.initTransports_ = function (e) {
          ...
          if (
            ...
            try {
              for (
                var a = _(gt.ALL_TRANSPORTS), s = a.next();
                !s.done;
                s = a.next()
              ) {
                var u = s.value;
      ...
      var mt =
        ((wt.prototype.start_ = function () {
          ...
          0 < t &&
            (this.healthyTimeout_ = Fe(function () {
          ...
          if ("d" in e) {
            ...
            if ("h" === t) this.onHandshake_(e);
              ...
              "s" === t
                ...
                : de("Unknown control packet command: " + t);
          }
        }),
        (wt.prototype.onHandshake_ = function (e) {
          ...
          (this.sessionId = e.s),
            ...
            0 === this.state_ &&
              ...
              "5" !== n && xe("Protocol version mismatch detected"),
      ...
      function wt(e, t, n, r, i, o, a, s, u, l) {
        (this.id = e),
          ...
          (this.state_ = 0),
          (this.log_ = Pe("c:" + this.id + ":")),
          (this.transportManager_ = new vt(t)),
          this.log_("Connection created"),
          this.start_();
      }
      var Ct =
        ((bt.prototype.put = function (e, t, n, r) {}),
        (bt.prototype.merge = function (e, t, n, r) {}),
        (bt.prototype.refreshAuthToken = function (e) {}),
        (bt.prototype.refreshAppCheckToken = function (e) {}),
        (bt.prototype.onDisconnectPut = function (e, t, n) {}),
        (bt.prototype.onDisconnectMerge = function (e, t, n) {}),
        (bt.prototype.onDisconnectCancel = function (e, t) {}),
        (bt.prototype.reportStats = function (e) {}),
        bt);
      function bt() {}
      var Tt =
      ...
      var Jt,
        ...
        en =
          (n(tn, (Jt = Ct)),
          (tn.prototype.sendRequest = function (e, t, n) {
                ...
                switch (e.label) {
                  case 0:
                    ...
                    this.log_("Making a connection attempt"),
                      ...
                      (i = this.id + ":" + tn.nextConnectionId_++),
                  ...
                  case 2:
                    return (
                      ...
                      (l = l[1]),
                      o
                        ? ke("getToken() completed but was canceled")
                        : (ke("getToken() completed. Creating connection."),
                  ...
                  case 3:
                    return (
                      ...
                      o || (this.repoInfo_.nodeAdmin && xe(h), s()),
                      [3, 4]
                    );
                  case 4:
                    return [2];
          ...
          (tn.prototype.interrupt = function (e) {
            ke("Interrupting connection for reason: " + e),
          ...
          (tn.prototype.resume = function (e) {
            ke("Resuming connection for reason: " + e),
          ...
          (tn.prototype.onAppCheckRevoked_ = function (e, t) {
            ke("App check token revoked: " + e + "/" + t),
          ...
          (tn.nextPersistentConnectionId_ = 0),
          (tn.nextConnectionId_ = 0),
          tn);
      function tn(e, t, n, r, i, o, a, s) {
        ...
        if (
          ...
          (u.appCheckTokenProvider_ = a),
          (u.authOverride_ = s),
          (u.id = tn.nextPersistentConnectionId_++),
          (u.log_ = Pe("p:" + u.id + ":")),
          (u.interruptReasons_ = {}),
          (u.listens = new Map()),
          (u.outstandingPuts_ = []),
          ...
          (u.connected_ = !1),
          (u.reconnectDelay_ = Xt),
          (u.maxReconnectDelay_ = Zt),
        ...
        return (
          Gt.getInstance().on("visible", u.onVisible_, u),
          -1 === e.host.indexOf("fblocal") &&
            St.getInstance().on("online", u.onOnline_, u),
          u
        );
      }
      var nn =
        ((rn.Wrap = function (e, t) {
          return new rn(e, t);
        }),
        rn);
      function rn(e, t) {
      ...
      var on,
        me =
          ((an.prototype.getCompare = function () {
      ...
      var sn,
        re =
          (n(un, (sn = me)),
          Object.defineProperty(un, "__EMPTY_NODE", {
            get: function () {
              return on;
            },
            set: function (e) {
      ...
      function dn(e, t, n, r, i) {
        (this.key = e),
          (this.value = t),
          (this.color = null != n ? n : dn.RED),
          (this.left = null != r ? r : yn.EMPTY_NODE),
          (this.right = null != i ? i : yn.EMPTY_NODE);
      }
      ...
      var _n,
        yn =
          ((vn.prototype.insert = function (e, t) {
            return new vn(
              this.comparator_,
              this.root_
          ...
          (vn.EMPTY_NODE = new Tt()),
          vn);
      function vn(e, t) {
        void 0 === t && (t = vn.EMPTY_NODE),
          (this.comparator_ = e),
          (this.root_ = t);
      }
      function gn(e, t) {
      ...
      var Cn,
        ...
        In = function (e) {
          ...
          e.isLeafNode()
            ...
            : g(e === _n || e.isEmpty(), "priority of unexpected type."),
            g(
              e === _n || e.getPriority().isEmpty(),
              "Priority nodes can't have a priority of their own."
            );
        },
        Sn =
          (Object.defineProperty(kn, "__childrenNodeConstructor", {
            get: function () {
              return Cn;
            },
            set: function (e) {
          ...
          (kn.prototype.getImmediateChild = function (e) {
            return ".priority" === e
              ? this.priorityNode_
              : kn.__childrenNodeConstructor.EMPTY_NODE;
          }),
          ...
          (kn.prototype.updateImmediateChild = function (e, t) {
            return ".priority" === e
              ...
              ? this
              : kn.__childrenNodeConstructor.EMPTY_NODE.updateImmediateChild(
                  e,
                  t
            ...
            return null === n
              ...
              : (g(
                ...
                this.updateImmediateChild(
                  n,
                  kn.__childrenNodeConstructor.EMPTY_NODE.updateChild(Lt(e), t)
                ));
          }),
            ...
            return (
              null === this.lazyHash_ &&
                ...
                this.priorityNode_.isEmpty() ||
                  (e += "priority:" + wn(this.priorityNode_.val()) + ":"),
                (e += (t = typeof this.value_) + ":"),
                (e += "number" == t ? Me(this.value_) : this.value_),
                (this.lazyHash_ = ce(e))),
              this.lazyHash_
            );
          }),
          ...
          (kn.prototype.compareTo = function (e) {
            return e === kn.__childrenNodeConstructor.EMPTY_NODE
              ? 1
              : e instanceof kn.__childrenNodeConstructor
              ? -1
          ...
          kn);
      function kn(e, t) {
        void 0 === t && (t = kn.__childrenNodeConstructor.EMPTY_NODE),
          (this.value_ = e),
          ...
          In(this.priorityNode_);
      }
      function Pn() {
        return (null !== En && En.apply(this, arguments)) || this;
      }
      var Nn = new (n(Pn, (En = me)),
        (Pn.prototype.compare = function (e, t) {
        ...
        xn = Math.log(2),
        Rn =
          ((Dn.prototype.nextBitIsOne = function () {
      ...
      function Dn(e) {
        var t;
        (this.count = ((t = e + 1), parseInt(Math.log(t) / xn, 10))),
      ...
      var On,
          ...
          var c = function (e, t) {
              ...
              if (1 == n)
                return (
                  (r = l[e]),
                  (i = h ? h(r) : r),
                  new pn(i, r.node, pn.BLACK, null, null)
                );
        ...
        Fn =
          (Object.defineProperty(qn, "Default", {
            get: function () {
              return (
                g(Nn, "ChildrenNode.ts has not been loaded"),
                (On = On || new qn({ ".priority": Mn }, { ".priority": Nn }))
              );
            },
            enumerable: !1,
            configurable: !0,
          ...
          (qn.prototype.addIndex = function (e, t) {
            ...
            for (
              var n = [], r = !1, i = t.getIterator(nn.Wrap), o = i.getNext();
              o;
              ...
              L(this.indexes_, function (e, t) {
                ...
                if ((g(n, "Missing index implementation for " + t), e === Mn)) {
                  if (n.isDefinedOn(a.node)) {
                    for (
                      var r = [], i = s.getIterator(nn.Wrap), o = i.getNext();
                      o;
                ...
                (t = s.get(a.name)), (n = e);
                return (n = t ? e.remove(new nn(a.name, t)) : n).insert(
                  a,
                  a.node
                );
              }),
      ...
      var Wn,
        jn =
          (Object.defineProperty(Un, "EMPTY_NODE", {
            get: function () {
          ...
          (Un.prototype.updatePriority = function (e) {
            return this.children_.isEmpty()
              ? this
              : new Un(this.children_, e, this.indexMap_);
          }),
          ...
          (Un.prototype.getChild = function (e) {
            ...
            return null === t
              ? this
              : this.getImmediateChild(t).getChild(Lt(e));
          }),
          ...
          (Un.prototype.val = function (n) {
            ...
            var r = {},
              ...
              a = !0;
            if (
              (this.forEachChild(Nn, function (e, t) {
                (r[e] = t.val(n)),
                  i++,
                  a && Un.INTEGER_REGEXP_.test(e)
          ...
          (Un.prototype.hash = function () {
            ...
            return (
              null === this.lazyHash_ &&
                ((n = ""),
                this.getPriority().isEmpty() ||
                  (n += "priority:" + wn(this.getPriority().val()) + ":"),
                this.forEachChild(Nn, function (e, t) {
                  t = t.hash();
                  "" !== t && (n += ":" + e + ":" + t);
                }),
                (this.lazyHash_ = "" === n ? "" : ce(n))),
              this.lazyHash_
            );
          }),
          ...
          (Un.prototype.getIteratorFrom = function (e, t) {
            ...
            for (
              var r = this.children_.getIteratorFrom(e.name, nn.Wrap),
                i = r.peek();
          ...
          (Un.prototype.getReverseIteratorFrom = function (e, t) {
            ...
            for (
              var r = this.children_.getReverseIteratorFrom(e.name, nn.Wrap),
                i = r.peek();
      ...
      function Un(e, t, n) {
        (this.children_ = e),
          ...
          (this.indexMap_ = n),
          (this.lazyHash_ = null),
          this.priorityNode_ && In(this.priorityNode_),
      ...
      Object.defineProperties(nn, {
        MIN: { value: new nn(Re, jn.EMPTY_NODE) },
        MAX: { value: new nn(De, Vn) },
      }),
        (re.__EMPTY_NODE = jn.EMPTY_NODE),
        (Sn.__childrenNodeConstructor = jn),
        (Tn = _n = Vn);
      var zn = !0;
      function Hn(n, e) {
        ...
        if (
          (Le(n, function (e, t) {
            "." !== e.substring(0, 1) &&
              ((t = Hn(t)).isEmpty() ||
                ((o = o || !t.getPriority().isEmpty()), i.push(new nn(e, t))));
          }),
          0 === i.length)
        )
          return jn.EMPTY_NODE;
      ...
      var Qn,
        ...
        Kn =
          (n(Gn, (Qn = me)),
          (Gn.prototype.extractChild = function (e) {
      ...
      function Xn(e) {
        ...
        return "-" === n[n.length - 1]
          ...
          : ((n[n.length - 1] = nr.charAt(nr.indexOf(n[n.length - 1]) - 1)),
      ...
      var ur =
        ((lr.prototype.updateChild = function (e, t, n, r, i, o) {
          ...
          return a.getChild(r).equals(n.getChild(r)) &&
            ...
            : (null != o &&
                (n.isEmpty()
                  ? e.hasChild(t)
                    ? o.trackChildChange(ar(t, a))
                    : g(
                        e.isLeafNode(),
                        "A child remove without an old child only makes sense on a leaf node"
                      )
                  : a.isEmpty()
                  ? o.trackChildChange(or(t, n))
                  : o.trackChildChange(sr(t, n, a))),
        ...
        (lr.prototype.updateFullNode = function (r, n, i) {
          return (
            null != i &&
              (r.isLeafNode() ||
                r.forEachChild(Nn, function (e, t) {
                  n.hasChild(e) || i.trackChildChange(ar(e, t));
                }),
              n.isLeafNode() ||
                n.forEachChild(Nn, function (e, t) {
                  var n;
                  r.hasChild(e)
                    ? (n = r.getImmediateChild(e)).equals(t) ||
                      i.trackChildChange(sr(e, t, n))
                    : i.trackChildChange(or(e, t));
                })),
      ...
      var hr =
        ...
        (cr.prototype.updateChild = function (e, t, n, r, i, o) {
          return (
            this.matches(new nn(t, n)) || (n = jn.EMPTY_NODE),
        ...
        (cr.prototype.updateFullNode = function (e, t, n) {
          ...
          var r = (r = t.withIndex(this.index_)).updatePriority(jn.EMPTY_NODE),
            i = this;
          return (
            t.forEachChild(Nn, function (e, t) {
              i.matches(new nn(e, t)) ||
        ...
        cr);
      function cr(e) {
        (this.indexedFilter_ = new ur(e.getIndex())),
      ...
      var pr =
        ((dr.prototype.updateChild = function (e, t, n, r, i, o) {
          return (
            this.rangedFilter_.matches(new nn(t, n)) || (n = jn.EMPTY_NODE),
        ...
        (dr.prototype.fullLimitUpdateChild_ = function (e, t, n, r, i) {
          ...
          if (s.hasChild(t)) {
            ...
            if (h && !n.isEmpty() && 0 <= d)
              return (
                null != i && i.trackChildChange(sr(t, n, c)),
            ...
            return null != p && this.rangedFilter_.matches(p)
              ? (null != i && i.trackChildChange(or(p.name, p.node)),
                c.updateImmediateChild(p.name, p.node))
              : c;
          }
          return !n.isEmpty() && h && 0 <= a(l, u)
            ? (null != i &&
                (i.trackChildChange(ar(l.name, l.node)),
                i.trackChildChange(or(t, n))),
              s
        ...
        dr);
      function dr(e) {
        (this.rangedFilter_ = new hr(e)),
          (this.index_ = e.getIndex()),
          (this.limit_ = e.getLimit()),
          (this.reverse_ = !e.isViewFromLeft());
      }
      var fr =
        ((_r.prototype.hasStart = function () {
        ...
        (_r.prototype.getIndexStartName = function () {
          return (
            g(this.startSet_, "Only valid if start has been set"),
            this.startNameSet_ ? this.indexStartName_ : Re
          );
        }),
        ...
        (_r.prototype.getIndexEndName = function () {
          return (
            g(this.endSet_, "Only valid if end has been set"),
            this.endNameSet_ ? this.indexEndName_ : De
          );
        }),
          ...
          e.isDefault() ||
            ((t =
              e.index_ === Nn
                ...
                : e.index_ === ln
                ? "$key"
                : (g(e.index_ instanceof Kn, "Unrecognized index type!"),
                  e.index_.toString())),
            (n.orderBy = x(t)),
            e.startSet_ &&
              ((n.startAt = x(e.indexStartValue_)),
              e.startNameSet_ && (n.startAt += "," + x(e.indexStartName_))),
            e.endSet_ &&
              ((n.endAt = x(e.indexEndValue_)),
              e.endNameSet_ && (n.endAt += "," + x(e.indexEndName_))),
            e.limitSet_ &&
              (e.isViewFromLeft()
      ...
      function wr(e) {
        ...
        return (
          ...
          e.limitSet_ &&
            ...
            (n.vf = t)),
          e.index_ !== Nn && (n.i = e.index_.toString()),
          n
        );
      }
      var Cr,
        br =
          (n(Tr, (Cr = Ct)),
          (Tr.prototype.reportStats = function (e) {
          ...
          (Tr.prototype.refreshAuthToken = function (e) {}),
          (Tr.prototype.restRequest_ = function (i, o, a) {
            var s = this;
            return (
      ...
      var Er =
        ((Ir.prototype.getNode = function (e) {
      ...
      var Rr,
        Dr =
          ((Or.prototype.reportStats_ = function () {
            var n = this,
      ...
      ((Ct = Rr = Rr || {})[(Ct.OVERWRITE = 0)] = "OVERWRITE"),
        (Ct[(Ct.MERGE = 1)] = "MERGE"),
        (Ct[(Ct.ACK_USER_WRITE = 2)] = "ACK_USER_WRITE"),
        (Ct[(Ct.LISTEN_COMPLETE = 3)] = "LISTEN_COMPLETE");
      var Fr =
        ((qr.prototype.operationForChild = function (e) {
          ...
          return (
            ...
            new qr(Lt(this.path), this.affectedTree, this.revert)
          );
        }),
        qr);
      function qr(e, t, n) {
        (this.path = e),
          (this.affectedTree = t),
          (this.revert = n),
          (this.type = Rr.ACK_USER_WRITE),
          (this.source = Ar());
      }
      var Wr =
        ((jr.prototype.operationForChild = function (e) {
          return jt(this.path)
            ? new jr(this.source, Dt())
            : new jr(this.source, Lt(this.path));
        }),
        jr);
      function jr(e, t) {
      ...
      var Ur =
        ((Br.prototype.operationForChild = function (e) {
          return jt(this.path)
            ? new Br(this.source, Dt(), this.snap.getImmediateChild(e))
            : new Br(this.source, Lt(this.path), this.snap);
        }),
        Br);
      function Br(e, t, n) {
        (this.source = e),
        ...
        ((zr.prototype.operationForChild = function (e) {
          if (jt(this.path)) {
            ...
            return t.isEmpty()
              ? null
              : t.value
              ? new Ur(this.source, Dt(), t.value)
              : new zr(this.source, Dt(), t);
          }
          return (
            g(
              Ot(this.path) === e,
            ...
            new zr(this.source, Lt(this.path), this.children)
          );
        }),
      ...
      function Gr(n, e, t, r) {
        ...
        return (
          ...
          $r(n, i, "child_removed", e, r, t),
          $r(n, i, "child_added", e, r, t),
          $r(n, i, "child_moved", o, r, t),
          $r(n, i, "child_changed", e, r, t),
          $r(n, i, "value", e, r, t),
          i
        );
      }
      function $r(o, a, t, e, s, u) {
        ...
        e.sort(function (e, t) {
          return (function (e, t, n) {
            ...
            (t = new nn(t.childName, t.snapshotNode)),
              (n = new nn(n.childName, n.snapshotNode));
      ...
      var ni =
        ...
        (ri.prototype.findRootMostMatchingPathAndValue = function (e, t) {
          ...
          return null == t
            ? null
            : { path: Wt(new xt(n), t.path), value: t.value };
        }),
      ...
      function hi(e, t) {
        ...
        return null != n
          ? e.writeTree_.get(n.path).getChild(Ut(n.path, t))
          : null;
      }
      function ci(e) {
        var n = [],
            ...
            (function (e, t) {
              {
                ...
                for (var n in e.children)
                  if (e.children.hasOwnProperty(n) && zt(Wt(e.path, n), t))
                    return !0;
                return !1;
              }
            })(u, r.path)
              ? (o = !1)
              : zt(r.path, u.path) && (a = !0)),
            s--;
        }
        return (
          !!o &&
          (a
            ? (((i = t).visibleWrites = gi(i.allWrites, vi, Dt())),
              0 < i.allWrites.length
                ? (i.lastWriteId = i.allWrites[i.allWrites.length - 1].writeId)
                : (i.lastWriteId = -1))
            : r.snap
            ? (t.visibleWrites = ui(t.visibleWrites, r.path))
      ...
      function gi(e, t, n) {
        for (var r = ii.empty(), i = 0; i < e.length; ++i) {
          ...
          if (t(o)) {
            ...
            if (o.snap)
              zt(n, a)
                ? (r = ai(r, (s = Ut(n, a)), o.snap))
                : zt(a, n) &&
                  ((s = Ut(a, n)), (r = ai(r, Dt(), o.snap.getChild(s))));
            else {
              if (!o.children)
                throw m("WriteRecord should have .snap or .children");
              zt(n, a)
                ? (r = si(r, (s = Ut(n, a)), o.children))
                : zt(a, n) &&
                  (jt((s = Ut(a, n)))
                    ? (r = si(r, Dt(), o.children))
                    : (o = O(o.children, Ot(s))) &&
                      ((s = o.getChild(Lt(s))), (r = ai(r, Dt(), s))));
            }
          }
        }
        return r;
      ...
      function Ci(e, t) {
        return (function (e, t, n) {
          ...
          if (i)
            return (
              i.isLeafNode() ||
                i.forEachChild(Nn, function (e, t) {
                  r = r.updateImmediateChild(e, t);
                }),
              r
            );
          ...
          return (
            ci(pi(e.visibleWrites, t)).forEach(function (e) {
              r = r.updateImmediateChild(e.name, e.node);
            }),
            r
          );
      ...
      function bi(e, t, n, r) {
        return (
          ...
          (e = Wt(e, t)),
          li(i.visibleWrites, e)
            ? null
            : di((e = pi(i.visibleWrites, e)))
            ? r.getChild(t)
            : fi(e, r.getChild(t))
        );
        var i;
      ...
      function Ti(e, t) {
        return (
          (n = e.writeTree), (t = Wt(e.treePath, t)), hi(n.visibleWrites, t)
        );
        var n;
      }
      ...
      function Ii(e, t, n) {
        return (
          ...
          null != (i = hi(r.visibleWrites, t))
            ...
            ? fi(pi(r.visibleWrites, t), e.getNode().getImmediateChild(n))
            : null
        );
        var r, i;
      }
      ...
      var Pi =
        ((Ni.prototype.trackChildChange = function (e) {
          var t = e.type,
            n = e.childName;
          g(
            "child_added" === t ||
      ...
      var Ri = new ((xi.prototype.getCompleteChild = function (e) {
        ...
        xi)(),
        Di =
          ((Oi.prototype.getCompleteChild = function (e) {
      ...
      function Ai(e, t, n, r, i) {
        var o,
          ...
          p,
          d = new Pi();
        if (n.type === Rr.OVERWRITE)
          var f = n,
            _ = f.source.fromUser
              ? Fi(e, t, f.path, f.snap, r, i, d)
              : (g(f.source.fromServer, "Unknown source."),
                (o =
                  f.source.tagged ||
                  (t.serverCache.isFiltered() && !jt(f.path))),
                Mi(e, t, f.path, f.snap, r, i, o, d));
                ...
                var a;
                {
                  ...
                  return (
                    jt(n) || ".priority" === Ot(n)
                      ...
                      : ((s = Ot(n)),
                        null == (u = Ii(r, s, t.serverCache)) &&
                          t.serverCache.isCompleteForChild(s) &&
                          (u = h.getImmediateChild(s)),
                        (i =
                          null != u
                            ? e.filter.updateChild(h, s, u, Lt(n), l, o)
                          ...
                          (a = wi(r, ti(t))).isLeafNode() &&
                          (i = e.filter.updateFullNode(i, a, o))),
                    (a =
                      t.serverCache.isFullyInitialized() ||
                      null != Ti(r, Dt())),
                    Xr(t, i, a, e.filter.filtersNodes())
                  );
                }
              })(e, t, v.path, r, i, d)
                  ...
                  u = t.serverCache;
                {
                  if (null != n.value) {
                    if (
                      ...
                      return Mi(e, t, r, u.getNode().getChild(r), i, o, s, a);
                    if (jt(r)) {
                      var l = new ni(null);
                      return (
                        u.getNode().forEachChild(ln, function (e, t) {
                          l = l.set(new xt(e), t);
                        }),
                        ji(e, t, r, l, i, o, s, a)
                      );
          ...
          (c = jt(n)
            ? (g(
              ...
              t.serverCache.isFiltered()
                ? ((s = Ci(r, (s = ti(t)) instanceof jn ? s : jn.EMPTY_NODE)),
            ...
            ? (g(
              ...
              null !=
              (h = bi(r, n, (l = a.getNode()), (p = t.serverCache.getNode())))
        ...
        if (jt(n)) c = l.updateFullNode(u.getNode(), r, null);
          ...
          c =
            ".priority" === a
              ...
              : l.updateChild(u.getNode(), a, r, h, Ri, null);
        }
      ...
      function Fi(e, t, n, r, i, o, a) {
        ...
        return jt(n)
          ? ((u = e.filter.updateFullNode(t.eventCache.getNode(), r, a)),
            Xr(t, u, !0, e.filter.filtersNodes()))
          : ".priority" === (s = Ot(n))
          ? ((u = e.filter.updatePriority(t.eventCache.getNode(), r)),
            Xr(t, u, l.isFullyInitialized(), l.isFiltered()))
          : ((i = Lt(n)),
            ...
            (u = jt(i)
              ...
              ? ".priority" === Mt(i) && n.getChild(qt(i)).isEmpty()
                ? n
                : n.updateChild(i, r)
              : jn.EMPTY_NODE),
            o.equals(u)
      ...
      function ji(r, i, e, t, o, a, s, u) {
        ...
        return (
          t.children.inorderTraversal(function (e, t) {
            h.hasChild(e) &&
              ((t = Wi(0, i.serverCache.getNode().getImmediateChild(e), t)),
              (l = Mi(r, l, new xt(e), t, o, a, s, u)));
          }),
          t.children.inorderTraversal(function (e, t) {
      ...
      var Ui,
        Bi =
          (Object.defineProperty(Vi.prototype, "query", {
            get: function () {
              return this.query_;
            },
            enumerable: !1,
      ...
      function Vi(e, t) {
        ...
        (this.viewCache_ = Jr(i, r)),
          (this.eventGenerator_ = new Kr(this.query_));
      }
      function zi(e) {
      ...
      function Qi(e, t, n, r) {
        ...
        return (
          ...
          Yi(e, t.changes, t.viewCache.eventCache.getNode(), null)
        );
      }
      function Yi(e, t, n, r) {
      ...
      function Ji(e, t, n, r, i) {
        ...
        (o = wi(n, i ? r : null)),
          (e = !1),
          (e = !!o || ((o = r instanceof jn ? Ci(n, r) : jn.EMPTY_NODE), !1)),
          (i = Jr(new Hr(o, e, !1), new Hr(r, i, !1)));
        return new Bi(t, i);
      }
      function Xi(e, t, n, r, i, o) {
        ...
        return (
          ...
          o.getNode().isLeafNode() ||
            o.getNode().forEachChild(Nn, function (e, t) {
              a.push(or(e, t));
            }),
          o.isFullyInitialized() && a.push(ir(o.getNode())),
          Yi(n, a, o.getNode(), t)
        );
      }
      function Zi(e, t, n, r) {
        ...
        return (
          l &&
            !io(e) &&
            s.push(
              (g(Ui, "Reference.ts has not been loaded"),
              new Ui(t._repo, t._path))
            ),
          { removed: s, events: u }
        );
      }
            ...
            var h = l.value,
              s =
                ...
                (i.query._queryParams.loadsAllData() ||
                  (!jt(o) && !a.getImmediateChild(Ot(o)).isEmpty()))
                  ? a.getChild(o)
                  : null);
        } catch (e) {
          n = { error: e };
      ...
      var ao = 1,
        so = function (e) {
          (this.listenProvider_ = e),
            (this.syncPointTree_ = new ni(null)),
      ...
      function uo(e, t, n, r, i) {
        ...
        return (
          ...
          u && (o.visibleWrites = ai(o.visibleWrites, a, s)),
          (o.lastWriteId = r),
          i ? vo(e, new Ur(Ar(), t, n)) : []
        );
      }
      function lo(e, t, n, r) {
        var i, o, a;
        (i = e.pendingWriteTree_),
          ...
          (i.visibleWrites = si(i.visibleWrites, o, a)),
          (i.lastWriteId = r);
        n = ni.fromObject(n);
      ...
      function po(n, e, t, r) {
        ...
        if (o && ("default" === e._queryIdentifier || ro(o, e))) {
          ...
          !s &&
            ...
            !r &&
            (o
              ? n.listenProvider_.stopListening(Io(e), null)
      ...
      function fo(e, t, n) {
        ...
        a
          ? ((o = o || io(a)), (i = i || to(a, Dt())))
          : ((a = new Gi()), (e.syncPointTree_ = e.syncPointTree_.set(r, a))),
          null != i
            ? (h = !0)
            : ((h = !1),
              (i = jn.EMPTY_NODE),
      ...
      function yo(e, t) {
        ...
        i
          ? (r = r || to(i, Dt()))
          : ((i = new Gi()), (e.syncPointTree_ = e.syncPointTree_.set(n, i)));
        var o = null != r,
        ...
        return ei(
          Ji(
            i,
            t,
            _i(e.pendingWriteTree_, t._path),
      ...
      function To(e) {
        ...
        return (
          ...
          { queryId: e.substr(t + 1), path: new xt(e.substr(0, t)) }
        );
      }
      function Eo(e, t, n) {
        ...
        return (
          ...
          $i(r, n, _i(e.pendingWriteTree_, t), null)
        );
      }
      function Io(e) {
        return e._queryParams.loadsAllData() && !e._queryParams.isDefault()
          ? (g(Ki, "Reference.ts has not been loaded"),
            new Ki(e._repo, e._path))
          : e;
      }
      var So =
        ((ko.prototype.getImmediateChild = function (e) {
      ...
      function Mo(e, r, i) {
        ...
        return (
          ...
          e.forEachChild(Nn, function (e, t) {
      ...
      function qo(e, t) {
        for (
          var n = t instanceof xt ? t : new xt(t), r = e, i = Ot(n);
          null !== i;
      ...
      function zo(e) {
        ...
        null !== e.parent &&
          ...
          i && e
            ? (delete t.node.children[n], t.node.childCount--, zo(t))
            : i ||
              e ||
              ((t.node.children[n] = r.node), t.node.childCount++, zo(t)));
      }
      function Ho(e) {
      ...
      function Yo(e, t, n, r) {
        if (!r || void 0 !== t) {
          ...
          Le(t, function (e, t) {
            e = new xt(e);
            if ((ta(i, t, Wt(n, e)), ".priority" === Mt(e) && !Zo(t)))
              throw new Error(
                i +
      ...
      var $o = /[\[\].#$\/\u0000-\u001F\u007F]/,
        ...
        ta = function (r, e, t) {
          ...
          if (fe(e))
            throw new Error(r + "contains " + e.toString() + " " + Yt(i));
          if ("string" == typeof e && e.length > Xo / 3 && V(e) > Xo)
            throw new Error(
              r +
      ...
      function sa(e, t) {
        for (var n = null, r = 0; r < t.length; r++) {
          var i = t[r],
            o = i.getPath();
          null === n || Vt(o, n.path) || (e.eventLists_.push(n), (n = null)),
      ...
      function fa(e, t, n, r) {
        (this.repoInfo_ = e),
          ...
          (this.eventQueue_ = new aa()),
          (this.nextWriteId_ = 1),
          (this.interceptServerDataCallback_ = null),
          (this.onDisconnect_ = Sr()),
          (this.transactionQueueTree_ = new Fo()),
          (this.persistentConnection_ = null),
          (this.key = this.repoInfo_.toURLString());
      }
      function _a(a, e, t) {
        if (
          ((a.stats_ = ot(a.repoInfo_)),
          a.forceRestClient_ ||
            0 <=
              (
                ("object" == typeof window &&
          ...
          (a.persistentConnection_ = new en(
            a.repoInfo_,
            e,
            function (e, t, n, r) {
              ga(a, e, t, n, r);
        ...
        0 <
          (h = i
            ...
            ? ((l = L(n, function (e) {
              ...
              (r = ni.fromObject(l)),
              vo(s, new Vr(Lr(), u, r)))
            : ((n = Hn(n)), co(e.serverSyncTree_, o, n))).length &&
          (t = Ra(e, o)),
          la(e.eventQueue_, t, h);
      }
      function ma(e, t) {
        wa(e, "connected", t),
          !1 === t &&
      ...
      function ba(r, i, e, t, o) {
        ka(r, "set", { path: i.toString(), value: e, priority: t });
        var n = va(r),
          e = Hn(e, t),
      ...
      function Ia(e, t, n) {
        n =
          ".info" === Ot(t._path)
            ? po(e.infoSyncTree_, t, n)
            : po(e.serverSyncTree_, t, n);
      ...
      function xa(t, e) {
        var n;
        (e = void 0 === e ? t.transactionQueueTree_ : e) || Aa(t, e),
          Wo(e)
            ? ((n = Oa(t, e)),
                      ...
                      if ("ok" === e) {
                        for (var n = [], r = 0; r < a.length; r++)
                          !(function (e) {
                            (a[e].status = 2),
                              (t = t.concat(
                                ho(i.serverSyncTree_, a[e].currentWriteId)
                              )),
                              a[e].onComplete &&
                                n.push(function () {
                        ...
                        Aa(i, qo(i.transactionQueueTree_, o)),
                          xa(i, i.transactionQueueTree_),
                          la(i.eventQueue_, o, t);
                ...
                !(function (e) {
                  ...
                  g(
                    ...
                    4 === o.status
                      ? ((t = o.abortReason),
                        (p = p.concat(
                          ho(u.serverSyncTree_, o.currentWriteId, (s = !0))
                        )))
                      : 0 === o.status &&
                        (p =
                          o.retryCount >= pa
                            ...
                            : ((n = Na(u, o.path, d)),
                              ...
                              void 0 !== (i = l[e].update(n.val()))
                                ? (ta(
                                  ...
                                  )).concat(ho(u.serverSyncTree_, a, !0)))
                                : ((t = "nodata"),
                                  p.concat(
                                    ho(
                                      u.serverSyncTree_,
      ...
      function Da(e, t) {
        for (
          var n = e.transactionQueueTree_, r = Ot(t);
          null !== r && void 0 === Wo(n);
            ...
            3 === n[a].status ||
              (1 === n[a].status
                ...
                : (g(
                  ...
                  n[a].unwatcher(),
                  (i = i.concat(
                    ho(e.serverSyncTree_, n[a].currentWriteId, !0)
                  )),
                  n[a].onComplete &&
                    r.push(
      ...
      var Va =
        ((za.prototype.onValue = function (e, t) {
      ...
      var Ha =
        ...
        (Qa.prototype.set = function (e) {
          ia("OnDisconnect.set", this._path),
            ea("OnDisconnect.set", e, this._path, !1);
          var t = new f();
          return (
            Ea(
              this._repo,
        ...
        (Qa.prototype.setWithPriority = function (e, t) {
          ia("OnDisconnect.setWithPriority", this._path),
            ea("OnDisconnect.setWithPriority", e, this._path, !1),
            Ko("OnDisconnect.setWithPriority", t, !1);
          var n,
            r,
            i,
            o,
        ...
        (Qa.prototype.update = function (e) {
          ia("OnDisconnect.update", this._path),
            Yo("OnDisconnect.update", e, this._path, !1);
          var t = new f();
          return (
            (function (n, r, i, o) {
              if (A(i))
      ...
      var Ya =
        (Object.defineProperty(Ka.prototype, "key", {
          get: function () {
      ...
      function $a(e) {
        ...
        if (
          ...
          (g(
            e.getIndex() instanceof Kn || e.getIndex() === tr,
            "unknown index type."
          ),
      ...
      var ts =
        (Object.defineProperty(ns.prototype, "priority", {
          get: function () {
      ...
      function rs(e, t) {
        return (
          (e = z(e))._checkNotDeleted("ref"),
          void 0 !== t ? os(e._root, t) : e._root
        );
      }
      function is(e, t) {
        ...
        return (
          ...
          rs(e, n.path.toString())
        );
      }
      function os(e, t) {
        return (
          (null === Ot((e = z(e))._path) ? ra : na)("child", "path", t, !1),
          new Za(e._repo, Wt(e._path, t))
        );
      }
      function as(e, t) {
      ...
      function ss(e, t) {
        ...
        return (
          (function (i, o, e, a) {
            ka(i, "update", { path: o.toString(), value: e });
            var s,
              t,
              n = !0,
              r = va(i),
            ...
            Le(e, function (e, t) {
              ...
              n
                ? (ke("update() called with empty data.  Don't do anything."),
                  Pa(0, a, "ok", void 0))
                : ((s = Ca(i)),
                  (t = lo(i.serverSyncTree_, o, u, s)),
                  sa(i.eventQueue_, t),
        ...
        return (
          ...
          (null != (e = yo(n.serverSyncTree_, r))
            ...
            : n.server_.get(r).then(
                ...
                function (e) {
                  return (
                    ka(n, "get for query " + x(r) + " failed: " + e),
      ...
      var ls =
        ...
        (hs.prototype.createEvent = function (e, t) {
          ...
          return new Wa(
            "value",
            this,
            new ts(e.snapshotNode, new Za(t._repo, t._path), n)
          );
        }),
      ...
      function ds(n, e, t, r, i) {
        ...
        return (
          ...
          (e =
            ".info" === Ot((t = n)._path)
              ? fo(a.infoSyncTree_, t, e)
              : fo(a.serverSyncTree_, t, e)),
          ua(a.eventQueue_, t._path, e),
          function () {
      ...
      function ms(e, t, n) {
        var r = null,
          n = n ? new Va(n) : null;
        "value" === t ? (r = new ls(n)) : t && (r = new cs(t, n)),
          Ia(e._repo, e, r);
      }
      var ws,
        Ct = function () {},
        Cs =
          ...
          (bs.prototype._apply = function (e) {
            ...
            if ((Ja(t), $a(t), e._queryParams.hasEnd()))
              throw new Error(
      ...
      var Ts,
        Es =
          (n(Is, (Ts = Ct)),
          (Is.prototype._apply = function (e) {
            ...
            var t,
              ...
              r =
                ...
                ((r =
                  t.index_ === ln
                    ? vr(t, (n = "string" == typeof n ? Xn(n) : n), r)
                    : vr(t, n, null == r ? Re : Xn(r))).endBeforeSet_ = !0),
                r);
            if ((Ja(r), $a(r), e._queryParams.hasEnd()))
              throw new Error(
      ...
      var Ns,
        xs =
          (n(Rs, (Ns = Ct)),
          (Rs.prototype._apply = function (e) {
            ...
            var t,
              ...
              r =
                ...
                ((r =
                  t.index_ === ln
                    ? yr(t, (n = "string" == typeof n ? Jn(n) : n), r)
                    : yr(t, n, null == r ? De : Jn(r))).startAfterSet_ = !0),
                r);
            if ((Ja(r), $a(r), e._queryParams.hasStart()))
              throw new Error(
      ...
      var Ds,
        Os =
          (n(As, (Ds = Ct)),
          (As.prototype._apply = function (e) {
      ...
      var Ls,
        Ms =
          (n(Fs, (Ls = Ct)),
          (Fs.prototype._apply = function (e) {
            if (e._queryParams.hasLimit())
              throw new Error(
      ...
      var Ys,
        Ks =
          (n(Gs, (Ys = Ct)),
          (Gs.prototype._apply = function (e) {
            Ga(e, "orderByValue");
      ...
      var $s,
        ...
        Zs =
          ...
          (eu.prototype._apply = function (e) {
            if (
              (ea("equalTo", this._value, e._path, !1),
            ...
            return new Cs(this._value, this._key)._apply(
              new ks(this._value, this._key)._apply(e)
            );
          }),
          eu);
      function eu(e, t) {
      ...
      (Js = Za),
        g(!Ui, "__referenceConstructor has already been defined"),
        (Ui = Js),
        (Xs = Za),
        g(!Ki, "__referenceConstructor has already been defined"),
        (Ki = Xs);
      ...
      function ou(e, t, n, r, i) {
        ...
        void 0 === o &&
          ...
          ke("Using default host for project ", e.options.projectId),
          (o = e.options.projectId + "-default-rtdb.firebaseio.com"));
        var a,
          s = Fa(o, i),
          u = s.repoInfo,
          r = void 0;
        (r = "undefined" != typeof process ? process.env[nu] : r)
          ? ((a = !0),
            (o = "http://" + r + "?ns=" + u.namespace),
            (u = (s = Fa(o, i)).repoInfo))
          : (a = !s.repoInfo.secure);
        t = i && a ? new Ye(Ye.OWNER) : new He(e.name, e.options, t);
        oa("Invalid Firebase Database URL", s),
          jt(s.path) ||
            Ne(
      ...
      var au =
        (Object.defineProperty(su.prototype, "_repo", {
          get: function () {
            return (
        ...
        Object.defineProperty(su.prototype, "_root", {
          get: function () {
            return (
              this._rootInternal ||
                (this._rootInternal = new Za(this._repo, Dt())),
              this._rootInternal
            );
          },
          enumerable: !1,
        ...
        (su.prototype._checkNotDeleted = function (e) {
          null === this._rootInternal &&
            Ne("Cannot call " + e + " on a deleted database.");
        }),
        su);
      function su(e, t) {
      ...
      function uu(e, t, n, r) {
        void 0 === r && (r = {}),
          (e = z(e))._checkNotDeleted("useEmulator"),
          e._instanceStarted &&
            Ne(
            ...
            ((e = (function (e, t) {
              ...
              return (
                ...
                [
                  ...
                  h.encodeString(JSON.stringify(e), !1),
                  "",
                ].join(".")
              );
      ...
      function lu(e) {
        (e = z(e))._checkNotDeleted("goOnline"),
      ...
      function du(i, e, t) {
        if (
          ((i = z(i)),
          ia("Reference.transaction", i._path),
          ...
          (function (e, t, n, r, i, o) {
            ...
            (a.currentInputSnapshot = n),
              void 0 === (r = a.update(n.val()))
                ...
                : (ta("transaction failed: Data returned ", r, a.path),
                  (a.status = 0),
                  (i = Wo((o = qo(e.transactionQueueTree_, t))) || []).push(a),
                  jo(o, i),
                  (o = void 0),
                  "object" == typeof r && null !== r && D(r, ".priority")
                    ...
                    : (o = (_o(e.serverSyncTree_, t) || jn.EMPTY_NODE)
                        .getPriority()
                        .val()),
                  (i = va(e)),
                  (o = Hn(r, o)),
                  ...
                  la(e.eventQueue_, t, a),
                  xa(e, e.transactionQueueTree_));
          })(
            i._repo,
            i._path,
            e,
            function (e, t, n) {
              ...
              e
                ? o.reject(e)
                : ((r = new ts(n, new Za(i._repo, i._path), Nn)),
                  o.resolve(new cu(t, r)));
            },
            n,
            t
          ),
      ...
      var fu =
        ((_u.prototype.cancel = function (t) {
      ...
      var gu =
        ...
        (mu.prototype.child = function (e) {
          return (
            ...
            (e = String(e)),
            na("DataSnapshot.child", "path", e, !1),
            new mu(this._database, this._delegate.child(e))
          );
        }),
        (mu.prototype.hasChild = function (e) {
          return (
            W("DataSnapshot.hasChild", 1, 1, arguments.length),
            na("DataSnapshot.hasChild", "path", e, !1),
        ...
        (mu.prototype.getRef = function () {
          return (
            ...
            new Tu(this._database, this._delegate.ref)
          );
        }),
      ...
      var wu =
        ((Cu.prototype.on = function (e, n, t, r) {
          var i = this;
        ...
        (Cu.prototype.once = function (e, n, t, r) {
          ...
          switch (e) {
            ...
            case "child_added":
              ...
              break;
            case "child_removed":
              gs(this._delegate, o, u, { onlyOnce: !0 });
              break;
            case "child_changed":
              ys(this._delegate, o, u, { onlyOnce: !0 });
              break;
            case "child_moved":
              vs(this._delegate, o, u, { onlyOnce: !0 });
              break;
            default:
              throw new Error(
        ...
        (Cu.prototype.startAfter = function (e, t) {
          return (
            ...
            new Cu(
              ...
              tu(
                this._delegate,
                ((e = e), Go("startAfter", "key", (t = t), !0), new xs(e, t))
              )
            )
          );
        }),
        (Cu.prototype.endAt = function (e, t) {
          return (
            ...
            new Cu(
              ...
              tu(
                this._delegate,
                ((e = e), Go("endAt", "key", (t = t), !0), new Cs(e, t))
              )
            )
          );
        }),
        (Cu.prototype.endBefore = function (e, t) {
          return (
            ...
            new Cu(
              ...
              tu(
                this._delegate,
                ((e = e), Go("endBefore", "key", (t = t), !0), new Es(e, t))
              )
            )
          );
        }),
        (Cu.prototype.equalTo = function (e, t) {
          return (
            ...
            new Cu(
              ...
              tu(
                this._delegate,
                ((e = e), Go("equalTo", "key", (t = t), !0), new Zs(e, t))
              )
            )
          );
        }),
        ...
        (Cu.prototype.isEqual = function (e) {
          if ((W("Query.isEqual", 1, 1, arguments.length), e instanceof Cu))
        ...
        Object.defineProperty(Cu.prototype, "ref", {
          get: function () {
            return new Tu(
              this.database,
              new Za(this._delegate._repo, this._delegate._path)
            );
          },
          enumerable: !1,
          configurable: !0,
        ...
        Tu =
          ...
          (Eu.prototype.child = function (e) {
            return (
              ...
              new Eu(this.database, os(this._delegate, e))
            );
          }),
          ...
          (Eu.prototype.update = function (e, t) {
            ...
            ia("Reference.update", this._delegate._path),
          ...
          (Eu.prototype.setWithPriority = function (e, t, n) {
            ...
            t = (function (e, t, n) {
              if (
                (ia("setWithPriority", e._path),
                ea("setWithPriority", t, e._path, !1),
                Ko("setWithPriority", n, !1),
          ...
          (Eu.prototype.onDisconnect = function () {
            return (
              ia("Reference.onDisconnect", this._delegate._path),
              new fu(new Ha(this._delegate._repo, this._delegate._path))
            );
          }),
      ...
      function Eu(e, t) {
        var n =
          bu.call(this, e, new Ya(t._repo, t._path, new fr(), !1)) || this;
        return (n.database = e), (n._delegate = t), n;
      }
      var Iu =
        ((Su.prototype.useEmulator = function (e, t, n) {
        ...
        (Su.prototype.goOffline = function () {
          ...
          W("database.goOffline", 0, 0, arguments.length),
            (e = z((e = this._delegate)))._checkNotDeleted("goOffline"),
            Sa(e._repo);
        }),
        (Su.prototype.goOnline = function () {
          return (
            W("database.goOnline", 0, 0, arguments.length), lu(this._delegate)
          );
        }),
        (Su.ServerValue = {
          TIMESTAMP: hu,
      ...
      var ku = Object.freeze({
          ...
          stats: function (e, t) {
            ...
            (e = e._delegate._repo),
              ...
              "undefined" != typeof console &&
                ((e = t
                  ? (e.statsListener_ || (e.statsListener_ = new Nr(e.stats_)),
          ...
          initStandalone: function (e) {
            ...
            return (
              ...
              { instance: new Iu(ou(t, r, void 0, n, e), t), namespace: o }
            );
          },
        }),
        Ct = en;
      ...
      var Pu,
        Nu = Object.freeze({
          ...
          hijackHash: function (i) {
            ...
            return (
              (en.prototype.put = function (e, t, n, r) {
      ...
      ae((Pu = t.default).SDK_VERSION),
        ...
        Pu.registerVersion("@firebase/database", "0.10.5");
    }.apply(this, arguments);
  } catch (e) {
    throw (
      (console.error(e),
